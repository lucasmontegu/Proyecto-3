...
var instrucciones = ['mover pieza hacia arriba', 'mover pieza hacia abajo', 'mover pieza hacia la derecha', 'mover pieza hacia la izquierda'];
// Arreglo para ir guardando los movimientos que se vayan realizando
var movimientos = ['arriba', 'abajo', 'derecha', 'izquierda'];
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  const tGrilla = grilla[filaPos1][columnaPos1];
  grilla[filaPos1][columnaPos1] = grilla[filaPos2][columnaPos2];
  grilla[filaPos2][columnaPos2] = tGrilla;
  //COMPLETAR
}
